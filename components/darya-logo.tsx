...
export function DaryaLogo({ className, size = 'md', showSubtitle = true }: DaryaLogoProps) {
  ...
  return (
    <div className={cn('flex items-center gap-3 select-none', className)}>
      ...
      <div className={cn('relative flex items-center justify-center rounded-xl bg-gradient-to-tr from-cyan-600 via-teal-500 to-sky-400 text-white shadow-lg shadow-cyan-500/25 shrink-0 transition-transform group-hover:scale-105', iconSizes[size])}>
        <svg
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
      ...
      <div className="flex flex-col justify-center">
        <div className={cn('font-black tracking-tight leading-none text-slate-900 dark:text-white flex items-center gap-0.5', textSizes[size])}>
        ...
        {showSubtitle && (
          <div className="flex items-center gap-1.5 mt-1 text-[10px] font-semibold text-slate-500 dark:text-slate-400 tracking-wider">
            {isRtl ? (
